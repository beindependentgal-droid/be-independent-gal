      ...
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            { label: "New members", value: summary.newMembers, icon: Activity },
            { label: "Pending flags", value: summary.pendingFlags, icon: AlertTriangle },
            { label: "Managed members", value: summary.totalMembers, icon: ShieldCheck },
          ].map((item) => {
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 space-y-3">
              {flaggedContent.length === 0 ? (
                <p className="text-sm text-slate-500">No moderation flags right now.</p>
              ) : (
