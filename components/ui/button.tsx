...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center gap-2 rounded-full border border-transparent bg-clip-padding text-[18px] font-heading font-semibold tracking-[0.01em] transition duration-300 ease-in-out outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: 'bg-gradient-to-r from-pink-600 to-violet-700 text-white shadow-[0_20px_50px_-20px_rgba(236,72,153,0.35)] hover:-translate-y-1 hover:from-violet-700 hover:to-pink-600 hover:shadow-[0_24px_60px_-18px_rgba(109,40,217,0.45)]',
        outline:
          'border-violet-300 bg-white text-violet-700 hover:bg-gradient-to-r hover:from-pink-600 hover:to-violet-700 hover:text-white hover:border-transparent shadow-sm shadow-violet-100',
        secondary:
          'bg-slate-900 text-white border border-slate-900 shadow-sm shadow-slate-200 hover:bg-gradient-to-r hover:from-pink-600 hover:to-violet-700 hover:text-white hover:border-transparent',
        ghost:
